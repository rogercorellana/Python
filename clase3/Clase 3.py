...
mi_var = l[0:85:2] # mi_var vale [99, “una lista”]  inicio:fin:de a dos
print(mi_var)

l = [99, True, "una lista"]
mi_var = l[1:] # mi_var vale [True, “una lista”]   inicio:fin no aclara entonces va al final

mi_var = l[:2] # mi_var vale [99, True]  inicio:fin
mi_var = l[:] # mi_var vale [99, True, “una lista”]   copiatodo
mi_var = l[::2] # mi_var vale [99, “una lista”]     inicio:fin:dedosendos
